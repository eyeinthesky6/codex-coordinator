...
- **You want to implement accepted work:** use the linked Issue and follow [CONTRIBUTING.md](CONTRIBUTING.md).
- **You found a security issue:** follow [SECURITY.md](SECURITY.md), not a public Issue or Discussion.

Please do not paste private task messages, credentials, local paths, or a project's live coordination state into any public report.
