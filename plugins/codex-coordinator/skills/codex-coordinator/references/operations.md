...
Queueing or waiting for idle controls delivery timing only. It never grants sender authority or turns an informational message into an executable command.
