...
It verifies only the packaged manifest, contract-38 capability file, skill frontmatter and links, state-helper syntax, project-lifecycle syntax, exact SessionStart/UserPromptSubmit/Stop registration, and hook syntax. It does not run a hook, inspect projects, read Codex databases or transcripts, scan rollouts, write diagrams, compare private paths, or modify installed files.
