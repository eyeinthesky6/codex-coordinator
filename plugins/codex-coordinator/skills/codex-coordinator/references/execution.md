...
6. Continue unfinished work under its existing user authority only when it remains necessary for the same current goal and can resume safely inside its recorded scope. Ask the user before reviving optional work, work from a superseded objective, materially expanded behavior or architecture, destructive or external action, or any item whose relevance or authority is unclear. Report the disposition of material historical tasks in the next consolidated update.
