...
class SessionStartHookTests(unittest.TestCase):
    def test_optional_autostart_is_disabled_before_package_parsing_or_execution(self) -> None:
        ...
        with (
            ...
            mock.patch.object(module.json, "loads", side_effect=AssertionError("parsed")),
    ...
    def test_optional_autostart_does_not_depend_on_co_located_runtime_bytes(self) -> None:
        module = _load_hook_module()
        missing_package = Path("missing-package")
        with mock.patch.object(module.subprocess, "Popen") as popen:
            module._start_mission_control(missing_package)
        popen.assert_not_called()
